...
//       try {
//         const response = await fetch("https://swipe-backend-s632.onrender.com/api/auth/signup", {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
//           },
      ...
      try {
        ...
        if (response.ok) {
          ...
          onComplete({
            ...
            bio: data.user.bio,
            photo: data.user.photo,
            age: 25, // default or get from user input if you want
          });
        } else {
          alert(data.message || "Signup failed!");
        }
